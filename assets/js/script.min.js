...
!function(e,t){var r,n,s=[],d=[];t("button.border").click(function(){t(".story").hasClass("borders")?t(".story").removeClass("borders"):t(".story").each(function(){t(this).addClass("borders")})}),t("button.add-story").click(function(){t("#addStoryModal").foundation("reveal","open")}),gridster=t(".paper ul").gridster({widget_base_dimensions:[160,160],resize:{enabled:!0}}).data("gridster");var i=function(e){return function(r,n){var s;s=[],substrRegex=new RegExp(r,"i"),t.each(e,function(e,t){substrRegex.test(t)&&s.push(t)}),n(s)}},o="http://wp-rest.dev/wp-json/wp/v2/";t.get(o+"posts?filter[posts_per_page]=-1",function(e){t(".result").html(e),r=e,t.each(r,function(e,t){s.push(t.title.rendered),d.push(t.id)}),t("#pendingStory.typeahead").typeahead({hint:!0,highlight:!0,minLength:1},{name:"titles",source:i(s)})}),t("#pendingStory").bind("typeahead:selected",function(e,d,i){n=r[s.indexOf(d)],t(".story-preview").html("<h3>"+n.title.rendered+"</h3>"+n.content.rendered.substring(0,200)+"...")}),t(".modal-add-story").click(function(){t("#addStoryModal").foundation("reveal","close"),t(".story-preview").html("This is where a preview of the story will go."),t("#pendingStory").val("");var e=t(".gridster ul").gridster().data("gridster"),r=n.title.rendered,s="Keanan Koppenhaver",d=n.content.rendered;html='<li class="story"><h2>'+r+"</h2><h3>By: "+s+'</h3><p class="body-copy">'+d+"</p></li>",e.add_widget(html,2,1)})}(window,jQuery);
